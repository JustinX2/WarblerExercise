...
@app.route('/explore-user/<int:user_id>')
def explore_user(user_id):
    user = User.query.get(user_id)
    print("User:", user)
    print("Messages by user:", user.messages)
    print("Followers of user:", [follower.username for follower in user.followers])
    print("Users followed by:", [followed.username for followed in user.following])
    print("Likes by user:", [(like.id, like.text) for like in user.likes])
...
#Step 2: Update Views to Handle Likes
